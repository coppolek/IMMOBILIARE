...
export const AddSeekerModal: React.FC<AddSeekerModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs overflow-y-auto">
      <div 
        id="add-seeker-modal"
        className="bg-white rounded-3xl border border-stone-200 shadow-2xl max-w-xl w-full overflow-hidden my-8 max-h-[90vh] flex flex-col"
      >
        ...
        <form onSubmit={handleSubmit} className="overflow-y-auto p-6 space-y-4 text-xs">
          ...
          <div className="pt-3 border-t border-stone-100 flex items-center justify-end gap-2">
            ...
            <button
              ...
              type="submit"
              className="px-5 py-2.5 bg-amber-500 hover:bg-amber-600 text-stone-950 font-bold rounded-xl shadow-xs"
            >
